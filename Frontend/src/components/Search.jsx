  ...
  return (
    <div className='sticky w-full top-0 z-10 flex items-center justify-center'>
        <div className='bg-transparent rounded relative'>
          ...
          <div className={` ${result?.length > 0 ? "flex" : "hidden"} px-2 bg-transparent text-white overflow-x-hidden overflow-y-auto hide-scrollbar absolute h-fit w-full max-h-100 flex flex-col`}>
            {
              result.map((r)=>(
